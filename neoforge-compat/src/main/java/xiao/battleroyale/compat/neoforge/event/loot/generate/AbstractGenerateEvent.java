...
import xiao.battleroyale.compat.neoforge.event.loot.AbstractLootEvent;

public class AbstractGenerateEvent<T extends BlockEntity> extends AbstractLootEvent {
