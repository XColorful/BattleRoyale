...
public class BattleRoyaleNeoforge {
    ...
    */
    ...
    public BattleRoyaleNeoforge(IEventBus modEventBus) {
        ...
        this.compatApi = new BattleRoyale.CompatApi(null);
        */
        ...
        BattleRoyale.init(mcSide,
                null, // this.registrarFactory,
                null, // this.mcRegistry,
                null, // this.networkAdapter,
                null, // this.networkHook,
                null, // this.eventRegister,
                null, // this.eventPoster,
                null, // this.blockModelRenderer,
                null  // this.compatApi
        );
