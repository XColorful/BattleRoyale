...
public class _FunctionRegisterHelper {
    ...
    protected static boolean registerEventClass(FunctionData apiFunction, ResourceLocation rl, boolean isTag, String eventClassStr, String priorityStr, boolean receiveCanceled) {
    ...
    protected static boolean unregisterEventClass(FunctionData apiFunction, ResourceLocation rl, boolean isTag, String eventClassStr) {
        Class<? extends ICustomEvent> eventClass = string_to_eventClass.get(eventClassStr);
