...
public class _PlayerDamageEventHandler implements IEventHandler {

    private _PlayerDamageEventHandler() {}

    private static class PlayerDamageEventHandlerHolder {
        private static final _PlayerDamageEventHandler INSTANCE = new _PlayerDamageEventHandler();
    }

    public static _PlayerDamageEventHandler get() {
