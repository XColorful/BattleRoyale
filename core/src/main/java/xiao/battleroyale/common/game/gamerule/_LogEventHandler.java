 ...
 * 监听玩家登出/登入
 */
public class _LogEventHandler implements IEventHandler {

    private static class LogEventHandlerHolder {
        private static final _LogEventHandler INSTANCE = new _LogEventHandler();
    }

    public static _LogEventHandler get() {
        return LogEventHandlerHolder.INSTANCE;
    }

    private _LogEventHandler() {}
    ...
    @Override public String getEventHandlerName() {
        return String.format("%s:LogEventHandler", BattleRoyale.MOD_ID);
    }
