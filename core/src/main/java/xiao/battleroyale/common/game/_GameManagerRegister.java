...
public class _GameManagerRegister implements ICustomEventHandler {

    private static class GameManagerRegisterHolder {
        private static final _GameManagerRegister INSTANCE = new _GameManagerRegister();
    }

    public static _GameManagerRegister get() {
        return GameManagerRegisterHolder.INSTANCE;
    }

    private _GameManagerRegister() {}
