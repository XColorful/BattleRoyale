...
import xiao.battleroyale.api.config.common.effect.IEffectConfigManager;
...
public class EffectConfigManager extends AbstractConfigManager implements IEffectConfigManager {
