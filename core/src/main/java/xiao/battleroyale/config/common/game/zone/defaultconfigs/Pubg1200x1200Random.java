...
public class Pubg1200x1200Random {

    private static final String DEFAULT_FILE_NAME = "example_1200x1200_random.json";

    private static final int INIT_ZONE_DELAY = 20 * 40; // 40秒

    private static final int ZONE3_MOVE_DELAY = 20 * 130;
    private static final int ZONE3_MOVE_TIME = 20 * 110;
    private static final int ZONE3_TIME = ZONE3_MOVE_DELAY + ZONE3_MOVE_TIME;
    private static final double ZONE3_SHRINK_RANGE = 0.45;
    private static final double ZONE3_SHRINK_SCALE = 0.55;
    ...
    private static final int GAME_TIME = INIT_ZONE_DELAY + ZONE3_TIME + ZONE4_TIME + ZONE5_TIME + ZONE6_TIME + ZONE7_TIME + ZONE8_TIME + ZONE9_TIME;

    public static void generateDefaultConfigs(String configDirPath) {
        JsonArray zoneConfigJson = new JsonArray();
        add1200x1200Zone(zoneConfigJson);
    ...
    private static void addPhase3(JsonArray zoneConfigJson) {
        addPhase(zoneConfigJson, 3, ZONE3_SHRINK_RANGE, ZONE3_SHRINK_SCALE, INIT_ZONE_DELAY, ZONE3_TIME,
                ZONE3_MOVE_DELAY, ZONE3_MOVE_TIME, ZONE3_DAMAGE, 3);
    }
