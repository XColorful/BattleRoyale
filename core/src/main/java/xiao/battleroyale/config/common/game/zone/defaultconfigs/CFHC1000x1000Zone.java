...
public class CFHC1000x1000Zone {
    ...
    public static void addPhase1(JsonArray zoneConfigJson, int phaseTime, double initRadius, int totalGamePhase, float damage, int maxGameTime) {
        ...
        ILootEntry lootEntry = new MultiEntry(Arrays.asList(
                new ItemEntry("minecraft:wooden_axe", "{Enchantments:[{lvl:10s,id:\"minecraft:efficiency\"},{lvl:3s,id:\"minecraft:unbreaking\"}]}" , 1), // We are 伐木不累!
                new ItemEntry("minecraft:iron_pickaxe", "{Enchantments:[{lvl:10s,id:\"minecraft:efficiency\"},{lvl:3s,id:\"minecraft:unbreaking\"}]}", 1), // 哇! 神稿
