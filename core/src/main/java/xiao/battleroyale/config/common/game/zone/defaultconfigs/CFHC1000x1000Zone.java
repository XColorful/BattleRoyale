...
public class CFHC1000x1000Zone {
    ...
    public static void addPhase1(JsonArray zoneConfigJson, int phaseTime, double initRadius, int totalGamePhase, float damage, int maxGameTime) {
        ...
        ILootEntry lootEntry = new MultiEntry(Arrays.asList(
                new ItemEntry("minecraft:wooden_axe", "{components:{\"minecraft:enchantments\":{\"minecraft:efficiency\":10,\"minecraft:unbreaking\":3}}}" , 1), // We are 伐木不累!
                new ItemEntry("minecraft:iron_pickaxe", "{components:{\"minecraft:enchantments\":{\"minecraft:efficiency\":10,\"minecraft:unbreaking\":3}}}", 1), // 哇! 神稿
