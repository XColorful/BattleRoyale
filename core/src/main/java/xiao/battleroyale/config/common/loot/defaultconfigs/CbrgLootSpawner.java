...
public class CbrgLootSpawner {
    ...
    private static ILootEntry commonAREntry() {
        ...
        MultiEntry mk47_mutantAmmo = gunBurstAmmoBuilder("classicr", "mk47", "cbrg", "ammo_762", 30);
        ...
        return new WeightEntry(Arrays.asList(
                ...
                new WeightedEntry(30, mk47_mutantAmmo),
    ...
    private static ILootEntry commonSREntry() {
        ...
        return new WeightEntry(Arrays.asList(
                ...
                new WeightedEntry(10, mosin_nagantAmmo),
                new WeightedEntry(25, kar98kAmmo),
                new WeightedEntry(35, win94Ammo)
        ));
    }
    ...
    private static ILootEntry commonDMREntry() {
        MultiEntry dragunovAmmo = gunSemiAmmoBuilder("suffuse","svd", "cbrg", "ammo_762", 10);
    ...
    private static ILootEntry commonSMGEntry() {
        ...
        MultiEntry mp9Ammo = gunAmmoBuilder("classicr", "mp9", "cbrg", "ammo_9mm", 30);
    ...
    private static ILootEntry commonPistolEntry() {
        ...
        MultiEntry r1895Ammo = gunSemiAmmoBuilder("hamster", "nagantm1895", "cbrg", "ammo_762", 15);
        // R45
        ...
        return new WeightEntry(Arrays.asList(
                ...
                new WeightedEntry(25, r1895Ammo),
    ...
    private static ILootEntry commonHealEntry() {
        return new WeightEntry(Arrays.asList(
                new WeightedEntry(28, new ItemEntry("minecraft:splash_potion",
                        "{components:{'minecraft:custom_name':'{\"text\":\"Bandage\",\"color\":\"white\",\"italic\":false}','minecraft:potion_contents':{custom_effects:[{id:\"minecraft:regeneration\",amplifier:0,duration:100,show_particles:0b,ambient:0b}]}}}", 1)),
                new WeightedEntry(16, new ItemEntry("minecraft:potion",
                        "{components:{'minecraft:custom_name':'{\"text\":\"First Aid Kit\",\"color\":\"red\",\"italic\":false}','minecraft:potion_contents':{custom_effects:[{id:\"minecraft:regeneration\",amplifier:3,duration:90,show_particles:0b,ambient:0b}]}}}", 1)),
                new WeightedEntry(2, new ItemEntry("minecraft:potion",
                        "{components:{'minecraft:custom_name':'{\"text\":\"Med Kit\",\"color\":\"blue\",\"italic\":false}','minecraft:potion_contents':{custom_effects:[{id:\"minecraft:regeneration\",amplifier:3,duration:120,show_particles:0b,ambient:0b}]}}}", 1))
    ...
    private static ILootEntry commonToolEntry() {
        return new WeightEntry(Arrays.asList(
                ...
                new WeightedEntry(5, new ItemEntry("vc_gliders:paraglider_wood", String.format("{components:{\"minecraft:damage\":%s}}", 332), 1))
