...
public class HorseVehicleEntitySpawner {
    ...
    public static float kmhToSpeed(int kmh) {
        return (float) (kmh / 151.7424);
    }

    private static ILootEntry generateCamel() {
        // 骆驼作为特殊载具，保持原样，只带鞍，不修改属性，不能装箱子
        return new EntityEntry("minecraft:camel", "{Tame:1b,equipment:{saddle:{id:\"minecraft:saddle\",count:1}}}", 1, 5);
    }

    private static ILootEntry generate60kmhHorse() {
        // 马：速度60km/h=0.833，血量20，跳跃力量1.0，钻石马铠带保护X
        float speed = kmhToSpeed(60);
        return new EntityEntry("minecraft:horse", "{Tame:1b,equipment:{saddle:{id:\"minecraft:saddle\",count:1},body:{components:{\"minecraft:enchantments\":{\"minecraft:protection\":10}},count:1,id:\"minecraft:diamond_horse_armor\"}},attributes:[{id:\"minecraft:movement_speed\",base:" + speed + "d},{id:\"minecraft:max_health\",base:20.0d},{id:\"minecraft:jump_strength\",base:1.0d}]}", 1, 5);
    }
    ...
    private static ILootEntry generate30kmhDonkey() {
        ...
        float speed = kmhToSpeed(30);
        return new EntityEntry("minecraft:donkey", "{Tame:1b,Items:[],ChestedHorse:1b,equipment:{saddle:{id:\"minecraft:saddle\",count:1}},attributes:[{id:\"minecraft:movement_speed\",base:" + speed + "d},{id:\"minecraft:max_health\",base:50.0d},{id:\"minecraft:jump_strength\",base:0.8d}]}", 1, 5);
    }

    private static ILootEntry generate40kmhMule() {
        // 骡子：速度40km/h=0.555555，血量40，跳跃高度2.5 (jump_strength约为0.7)
        float speed = kmhToSpeed(40);
        return new EntityEntry("minecraft:mule", "{Tame:1b,Items:[],ChestedHorse:1b,equipment:{saddle:{id:\"minecraft:saddle\",count:1}},attributes:[{id:\"minecraft:movement_speed\",base:" + speed + "d},{id:\"minecraft:max_health\",base:40.0d},{id:\"minecraft:jump_strength\",base:0.7d}]}", 1, 5);
    }
}