...
public class HorseVehicleEntitySpawner {
    ...
    private static ILootEntry generate60kmhHorse() {
        ...
        return new EntityEntry("minecraft:horse", "{Tame:1b,SaddleItem:{id:\"minecraft:saddle\",Count:1b},ArmorItem:{id:\"minecraft:diamond_horse_armor\",Count:1b,tag:{Enchantments:[{id:\"minecraft:protection\",lvl:10s}]}},Attributes:[{Name:\"minecraft:generic.movement_speed\",Base:" + speed + "d},{Name:\"minecraft:generic.max_health\",Base:20.0d},{Name:\"minecraft:horse.jump_strength\",Base:1.0d}]}", 1, 5);
    }
    ...
    private static ILootEntry generate30kmhDonkey() {
        ...
        return new EntityEntry("minecraft:donkey", "{Tame:1b,Items:[],ChestedHorse:1b,SaddleItem:{id:\"minecraft:saddle\",Count:1b},Attributes:[{Name:\"minecraft:generic.movement_speed\",Base:" + speed + "d},{Name:\"minecraft:generic.max_health\",Base:50.0d},{Name:\"minecraft:horse.jump_strength\",Base:0.8d}]}", 1, 5);
    }

    private static ILootEntry generate40kmhMule() {
        // 骡子：速度40km/h=0.555555，血量40，跳跃高度2.5 (jump_strength约为0.7)
        float speed = kmhToSpeed(40);
        return new EntityEntry("minecraft:mule", "{Tame:1b,Items:[],ChestedHorse:1b,SaddleItem:{id:\"minecraft:saddle\",Count:1b},Attributes:[{Name:\"minecraft:generic.movement_speed\",Base:" + speed + "d},{Name:\"minecraft:generic.max_health\",Base:40.0d},{Name:\"minecraft:horse.jump_strength\",Base:0.7d}]}", 1, 5);
    }
}