...
public class SecondObjectiveEntry {
    ...
    public SecondObjectiveEntry(@NotNull String player_attack_rate, @NotNull String player_kd, @NotNull String player_win_rate) {
    ...
    public @NotNull SecondObjectiveEntry copy() {
        return new SecondObjectiveEntry(player_attack_rate, player_kd, player_win_rate);
    }
    ...
    public static SecondObjectiveEntry fromJson(JsonObject jsonObject) {
        ...
        return new SecondObjectiveEntry(attack_rate, kd, win_rate);
    }
}