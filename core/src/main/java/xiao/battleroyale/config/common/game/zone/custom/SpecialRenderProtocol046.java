...
public class SpecialRenderProtocol046 {
    ...
    public static final String SPLIT_DISTANCE_DIMENSION = "distDim";
    ...
    protected static SpecialRenderProtocol fromTag(@NotNull JsonObject jsonTag) {
        try {
            ...
            return new SpecialRenderProtocol(hideInSpectate, heightOffset, side, _3dDistance, distDimStr, distMul, distAdd, innerColor, outsideColor);
        } catch (Exception e) {
            return null;
        }
    }
