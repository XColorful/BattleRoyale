...
public interface IDeathMatchDataManagement extends IDeathMatchInfoGetter {
     ...
     */
    @Deprecated
    default boolean addGamePlayerKill(GamePlayer gamePlayer, int addKill) {
        return addGameTeamKill(gamePlayer.getTeam(), addKill);
    }
     ...
     * @return 是否计入成功
     */
    boolean addGameTeamKill(GameTeam gameTeam, int addKill);
