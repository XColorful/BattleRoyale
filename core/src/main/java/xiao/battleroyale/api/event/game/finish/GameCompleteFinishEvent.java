...
public class GameCompleteFinishEvent extends AbstractGameStatsEvent {
    ...
    @Override public String getTextName() {
        return "CBR GameCompleteFinishEvent";
    }
    @Override public Component getDisplayName() {
        return Component.literal(getTextName());
    }

    private static final EventDispatcher<ICustomEventHandler, ICustomEvent, CustomEventType> _EVENT_DISPATCHER = BattleRoyale.getEventPoster().getEventDispatcher(GameCompleteFinishEvent.class);
