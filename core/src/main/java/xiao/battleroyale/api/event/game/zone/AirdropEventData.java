...
public class AirdropEventData extends AbstractSpecialZoneEventData {

    public final List<ItemStack> lootItems;
    public final List<ItemStack> lastLootItems;
    public @NotNull final CompoundTag nbt;
    public final LootGenerator.LootContext lootContext;
    public final ILootEntry lootEntry;

    public AirdropEventData(IGameManager gameManager, @NotNull ZoneManager.ZoneTickContext zoneTickContext,
