...
public class ZoneTickEvent extends AbstractGameTickEvent {
    ...
    private static final EventDispatcher<ICustomEventHandler, ICustomEvent, CustomEventType> _EVENT_DISPATCHER = BattleRoyale.getEventPoster().getEventDispatcher(ZoneTickEvent.class);
