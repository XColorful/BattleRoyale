...
public class GameLootBfsFinishEvent extends AbstractGameTickFinishEvent {
    ...
    private static final EventDispatcher<ICustomEventHandler, ICustomEvent, CustomEventType> _EVENT_DISPATCHER = BattleRoyale.getEventPoster().getEventDispatcher(GameLootBfsFinishEvent.class);
