...
public class CustomZoneEvent extends AbstractSpecialZoneEvent {
    ...
    private static final EventDispatcher<ICustomEventHandler, ICustomEvent, CustomEventType> _EVENT_DISPATCHER = BattleRoyale.getEventPoster().getEventDispatcher(CustomZoneEvent.class);
