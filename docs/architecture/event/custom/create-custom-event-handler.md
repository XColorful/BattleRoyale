...
# 创建自定义事件处理器
> [事件API](/docs/architecture/api/event-api.md)

1. 查看[自定义事件类型](/docs/api/event/CustomEventType.md)
2. [注册自定义事件处理器](/docs/architecture/api/event-api.md#注册自定义事件处理器)
3. 创建事件处理器
...
# English
> [Event API](/docs/architecture/api/event-api.md#English)

1. Check [Custom event type](/docs/api/event/CustomEventType.md)
2. [Register custom event handler](/docs/architecture/api/event-api.md#Register-custom-event-handler)
