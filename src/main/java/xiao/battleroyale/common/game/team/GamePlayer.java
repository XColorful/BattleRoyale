...
public class GamePlayer {
    ...
    private final int gameTeamId; // 队伍编号
    ...
    public GamePlayer(@NotNull UUID playerId, @NotNull String playerName, int gameSingleId, int gameTeamId, String gameTeamColor, boolean isBot) {
