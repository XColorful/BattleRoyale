...
public class DebugManager {
        ...
        gmCommand.then(Commands.literal(useFullName ? DEBUG : DEBUG_SHORT)
                .then(Commands.argument(ENTITY, EntityArgument.entity())
                        .then(Commands.argument(BOOL, BoolArgumentType.bool())
                                .executes(DebugManager::debugPlayer))));
    }
     ...
     * 修改调试玩家
     */
    private static int debugPlayer(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
        Entity entity = EntityArgument.getEntity(context, ENTITY);
        boolean add = BoolArgumentType.getBool(context, BOOL);
