...
public class GetCommand {
    ...
    public static LiteralArgumentBuilder<CommandSourceStack> get(boolean useFullName) {
        LiteralArgumentBuilder<CommandSourceStack> getCommand = Commands.literal(GET);

        GetGame.addGame(getCommand, useFullName);
        GetLoot.addLoot(getCommand, useFullName);
        GetMessage.addMessage(getCommand, useFullName);
        GetEffect.addEffect(getCommand, useFullName);
        GetWorld.addWorld(getCommand, useFullName);
