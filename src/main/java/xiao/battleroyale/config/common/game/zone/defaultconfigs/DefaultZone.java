...
public class DefaultZone {
    ...
    private static JsonObject generateDefaultZoneConfig1() {
        ...
        config.addProperty(ZoneConfigTag.ZONE_NAME, "Simple Border");
        config.addProperty(ZoneConfigTag.ZONE_COLOR, "#0000FF");
    ...
    private static JsonObject generateDefaultZoneConfig2() {
        ...
        config.addProperty(ZoneConfigTag.ZONE_NAME, "Blue Circle");
        config.addProperty(ZoneConfigTag.ZONE_COLOR, "#0000FF");
