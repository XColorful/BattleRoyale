...
public class Pubg5340x5340Casual {
    ...
    private static final double ZONE1_SHRINK_SCALE = Math.sqrt(5340*5340 * 0.55 / Math.PI) / (2670 * Math.sqrt(2)); // 缩圈后dimension相对于原先的倍数，约为0.592
    ...
    private static final double ZONE2_SHRINK_RANGE = 0.4;
    private static final double ZONE2_SHRINK_SCALE = 0.6;
    ...
    private static final int ZONE4_MOVE_TIME = 20 * 60;
    ...
    private static final int ZONE5_MOVE_DELAY = 20 * 90;
    ...
    private static final int ZONE6_MOVE_DELAY = 20 * 70;
    ...
    private static final int ZONE8_MOVE_DELAY = 20 * 30;
    ...
    private static final double ZONE8_SHRINK_SCALE = 0.001;
    private static final float ZONE8_DAMAGE = 9F / 5F;

    private static final int GAME_TIME = INIT_ZONE_DELAY + ZONE1_TIME + ZONE2_TIME + ZONE3_TIME + ZONE4_TIME + ZONE5_TIME + ZONE6_TIME + ZONE7_TIME + ZONE8_TIME;
    ...
    private static void add5340x5340Zone(JsonArray zoneConfigJson) {
        zoneConfigJson.add(generateBorder(5340 / 2F, GAME_TIME));
    }
